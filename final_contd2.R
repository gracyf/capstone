...
#tweet_file_sample <- as.data.frame(tweet_file[rbinom(nrow(tweet_file)*.5,nrow(tweet_file),.7), ])
#colnames(tweet_file_sample) <- "text"
#tweet_file_sample[] <- lapply(tweet_file_sample, as.character)
#print("rows to process")
#print(nrow(tweet_file_sample))
...
#twitter_file <- as.data.frame(tweet_file[1:100000,])
